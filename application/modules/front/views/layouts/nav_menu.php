<?php $pageType = $this->params['_pageType']; ?>

<div class="menu">
	<ul>
		<?php if (strcmp($pageType, "home") == 0)
			echo '<li><span class="selectedMenuItem"><a href="/">Home</a></span></li>' . "\n";
		else
			echo '<li><a href="/">Home</a></li>' . "\n";
		if (strcmp($pageType, "collection") == 0 or strcmp($pageType, "book") == 0 or strcmp($pageType, "hadith") == 0)
			echo '<li><span class="selectedMenuItem"><a href="/" target="_self">Collections</a></span>' . "\n";
		else
			echo '<li><a href="/" target="_self" >Collections</a>' . "\n";
		?>
		<ul>
		...
		<?php
		if (strcmp($pageType, "about") == 0)
			echo '<li><span class="selectedMenuItem"><a href="/about">About</a></span><ul>' . "\n";
		else
			echo '<li><a href="/about">About</a><ul>' . "\n";
		...
		echo '</ul></li>';
		if (strcmp($pageType, "contact") == 0)
			echo '<li><span class="selectedMenuItem"><a href="/contact">Contact</a></span></li>' . "\n";
		else
		...
		<?php if (strcmp($pageType, "home")) {
			$searchQuery = NULL;
			if (strcmp($pageType, "search") == 0)
				$searchQuery = $this->params['_searchQuery'];
			?>
			<div style="float: right; padding-right: 10px; padding-top:2px;"><a href="/searchtips"
					style="font-weight: normal; font-size: 10px; color: #000000;">Search Tips</a></div>
			<div
				style="float: right; display: inline; padding-right: 7px; padding-top: 2px; vertical-align: center; height: 95%;">
				<form name="searchform" action="/search_redirect.php" method="get" style="height: 100%;" id="searchform">
					<div class="searchbox-container" style="display: inline-block;">
						<input type="text" size="25" class="input_search" name="query"
							value="<?php echo htmlspecialchars($searchQuery); ?>" id="searchBox" />
						...
						<input type="submit" class="search_button" value="Search" id="searchButton" />
					</div>
				</form>
			</div>
			<style>

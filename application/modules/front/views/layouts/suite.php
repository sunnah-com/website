...
const toggleGlobalTextColor=(isLight)=> {
    ...
    // Update the <style> tag content to change the global text color to black
    globalStyle.innerHTML = `* { color: ${isLight?"none":"#ffffff"}; }`;

    document.body.style.background=isLight?"#ffffff":"var(--site-bg)";
  }

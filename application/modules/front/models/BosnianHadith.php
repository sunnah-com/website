...
/**
 * This is the model class for table "BosnianHadithTable".
 *
 * The followings are the available columns in table 'BosnianHadithTable':
 ...
 */
class BosnianHadith extends Hadith
{
    ...
    public function search()
    {
        ...
        $criteria->compare('bosnianURN',$this->bosnianURN);

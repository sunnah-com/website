<div id="copyContainer">
	...
	<div style="width:100%; text-align:center; display:flex;">
		<div style="flex:1;"></div><button id="btnCopy" style="font-size:14px; padding:5px 25px; flex:1;" onclick="copyToClipboard(this);">Copy</button><div style="flex:1;"><span id="copyError" style="display:none; font-size:14px; line-height:30px;"></span></div>
	</div>
</div>